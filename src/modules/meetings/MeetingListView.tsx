...
export const MeetingListView: React.FC = () => {
  ...
  return (
    <div className="space-y-5 pb-12">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-xs border border-slate-200/80 grid grid-cols-1 sm:grid-cols-3 gap-3">
        {/* Search */}
          ...
          meetings.map((meeting) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-2xl p-4 sm:p-5 shadow-xs border border-slate-200/90 hover:border-teal-400 hover:shadow-md transition-all cursor-pointer group"
              >
                <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
                  ...
                  <div className="text-xs font-bold text-teal-700 group-hover:translate-x-[-4px] transition-transform flex items-center gap-1">
                    <span>مشاهده جزئیات و صورتجلسه</span>
                    <ChevronLeft className="w-4 h-4" />
                  </div>
                </div>

                <h3 className="text-sm sm:text-base font-extrabold text-slate-800 mb-2 group-hover:text-teal-900 transition-colors">
                  {meeting.title}
                </h3>
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs text-slate-500 pt-3 border-t border-slate-100">
                  ...
                  <div className="flex items-center gap-1.5 font-bold text-teal-800 mr-auto bg-teal-50/80 px-2 py-0.5 rounded-md">
